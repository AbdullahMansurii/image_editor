...
class FrontEnd:
    ...
    def menu_initialisation(self):
        ...
        self.master.title("'Abdullah's Image Editor")        
        self.frame_header = ttk.Frame(self.master)
        self.frame_header.pack()
        self.master.configure(bg = '#323946') #to Change Bg Color
        ...
        self.frame_menu.config(relief=RIDGE, padding=(50, 15)) #to Add padding around frame
    ...
    def draw(self, event):
        ...
        cv2.line(self.filtered_image, (int(self.x * self.ratio), int(self.y * self.ratio)),
                 ...
                 (0, 0, 255), thickness=int(self.ratio * 2),lineType=8)
